...
- Typed OpenEnv models are defined in [models.py](/Users/harsh/Desktop/gitRepos/openenv/models.py).
- The environment implements `reset()`, `step()`, and `state()`.
- [openenv.yaml](/Users/harsh/Desktop/gitRepos/openenv/openenv.yaml) is included.
...
- [tasks.py](/Users/harsh/Desktop/gitRepos/openenv/tasks.py)
  task descriptors, seeded workspace generation, and task metadata
- [graders.py](/Users/harsh/Desktop/gitRepos/openenv/graders.py)
  deterministic execution harness, lint checks, and reward computation
- [models.py](/Users/harsh/Desktop/gitRepos/openenv/models.py)
  typed action, observation, and state models
- [client.py](/Users/harsh/Desktop/gitRepos/openenv/client.py)
  WebSocket client
- [trl_env.py](/Users/harsh/Desktop/gitRepos/openenv/trl_env.py)
  TRL tool wrapper
- [inference.py](/Users/harsh/Desktop/gitRepos/openenv/inference.py)
  reproducible baseline runner
- [smoke_test.py](/Users/harsh/Desktop/gitRepos/openenv/smoke_test.py)
  local sanity test
- [server/app.py](/Users/harsh/Desktop/gitRepos/openenv/server/app.py)
  FastAPI/OpenEnv app entrypoint
- [server/environment.py](/Users/harsh/Desktop/gitRepos/openenv/server/environment.py)
  main environment loop
- [scripts/validate-submission.sh](/Users/harsh/Desktop/gitRepos/openenv/scripts/validate-submission.sh)
  local copy of the hackathon validator
- [Dockerfile](/Users/harsh/Desktop/gitRepos/openenv/Dockerfile)
...
[trl_env.py](/Users/harsh/Desktop/gitRepos/openenv/trl_env.py) exposes tool methods for `GRPOTrainer(environment_factory=CodeReviewToolEnv)`:
...
[inference.py](/Users/harsh/Desktop/gitRepos/openenv/inference.py) is submission-compliant:
...
Environment variables used by [inference.py](/Users/harsh/Desktop/gitRepos/openenv/inference.py):
